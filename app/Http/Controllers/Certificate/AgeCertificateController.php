...
class AgeCertificateController extends Controller
{
    ...
    public function bn_certificate($id){
        ...
        $html = view('backend.pages.certificate.age.bn_certificate', $data)->render();
        $pdf = PDF::loadHTML($html)->setPaper('a4', 'landscape')
        ->setOptions([
            'fontDir' => base_path('/public/fonts/SolaimanLipi.ttf'),
            'defaultFont' => 'SolaimanLipi',
            'isHtml5ParserEnabled' => true,
            'isRemoteEnabled' => true
        ]);
        return $pdf->stream('age-bn_certificate.pdf');
    }
