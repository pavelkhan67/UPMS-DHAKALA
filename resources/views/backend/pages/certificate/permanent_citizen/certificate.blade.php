...
<head>
    ...
    <title>Permanent Citizen Certificate</title>
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <h2 class="text-light bg-success bold line-height">Permanent Citizen Certificate</h2>
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <p class="text-justify line-height">This is to certify that <strong class="text-blue">{{ $certificate->user->name ?? '' }}</strong>
                                                ...
                                                Dist.: <strong class="text-blue">{{ $certificate->user->institute->union->thana->district->name ?? '' }}</strong>,
                                                is known to me for about long time. He is a citizen of Bangladesh by birth.
                                            </p>
                                            <p>To the best of my knowledge, he/she is a Permanent Citizen of Bangladesh.</p>
