...
<head>
    ...
    <title>Disability Certificate</title>
                                ...
                                <thead>
                                    <tr>
                                        <td colspan="3" class="text-center">
                                            <img height="85" width="90" class="mx-auto d-block" src="{{ asset($certificate->user->institute->top_image) }}" alt="top_image">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <h1 class="text-light bg-success bold">Disability Certificate</h1>
                                        </td>
                                ...
                                <tbody>
                                    <tr>
                                        <td colspan="3">
                                            ...
                                            <p>To the best of my knowledge, he/she has Disability issue.</p>
