                        ...
                        <div class="card-body">
                            <table>
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        <td class="text-right mr-2">
                                            ...
                                            <img height="85" width="90" class="mx-auto d-block"
                                        ...
                                        <td class="text-center">
                                            ...
                                            <h2 class="text-light bg-success bold">Certificate of Death </h2>
                                        </td>
                                ...
                                <tbody>
                                    <tr>
                                        <td colspan="3">
                                            <p class="text-justify line-height">This is to certify that <strong
                                                ...
                                                Dist.: <strong
                                                    class="text-blue">{{ $certificate->user->institute->union->thana->district->name ?? '' }}</strong>,
                                                is known to me for about long time. He/She is a citizen of Bangladesh by birth.
                                            </p>
                                            <p>To the best of my knowledge, he/she is Dead.</p>
                                            <p>I wish all success and prosperity in his/her afterlife.</p>
