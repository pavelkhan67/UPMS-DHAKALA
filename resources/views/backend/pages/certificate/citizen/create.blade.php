      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('citizen.index')}}">Citizen Certificate</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal" id="citizenCertificateForm" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                            ...
                            <div class="card-footer">
                                <div class="form-group row">
                                    <a href="{{route('citizen.index')}}" class="btn btn-default float-right">Cancel</a>
                                    <div class="col-sm-9">
...
@push('script')
    ...
    <script>
         ...
         $(document).ready(function() {
             $(".select2").select2();
            $("#citizenCertificateForm").on('submit', function(e) {
                e.preventDefault();
                let thisForm = $(this);
                $.ajax({
                    type: "POST",
                    url: "{{ route('citizen.store') }}",
