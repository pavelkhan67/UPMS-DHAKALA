                                ...
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <h2 class="text-light bg-success bold">Age Certificate</h2>
                                        </td>
                                ...
                                <tbody>
                                    <tr>
                                        <td colspan="3">
                                            ...
                                            <p>To the best of my knowledge, he/her age is <strong
                                                    class="text-blue">{{ $user->people->date_of_birth ?? '--' }}</strong> year. </p>
