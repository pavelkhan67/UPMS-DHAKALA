      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('unmarried.index')}}">Unmarried Certificate</a></li>
                    ...
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" id="certificateForm" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-footer">
                                <div class="form-group row">
                                    <a href="{{route('unmarried.index')}}" class="btn btn-default float-right">Cancel</a>
                                    <div class="col-sm-9">
