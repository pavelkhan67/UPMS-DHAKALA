...
@section('content')
   ...
   <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Edit Organization Subtype</h1>
        </div>
        <div class="col-sm-6">
                        ...
                        <form class="form-horizontal" id="organizationCateogryForm" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="en_name" value="{{$subtype->en_name}}" placeholder="Organization Type" class="form-control" id="en_name">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="bn_name" value="{{$subtype->bn_name}}" placeholder="Organization Type Bangla" class="form-control" id="bn_name">
                                    </div>
                                </div>
                                        ...
                                        <select required name="organization_type_id" id="organization_type_id" class="form-control">
                                            ...
                                            @if (count($types))
                                                @foreach ($types as $type)
                                                    <option value="{{$type->id}}" {{$subtype->organization_type_id == $type->id ? "selected" : ""}}>{{$type->en_name}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#organizationCateogryForm").on('submit', function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('basic-settings.organization-subtype.update', $subtype->id)}}",
