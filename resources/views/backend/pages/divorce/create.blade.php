@extends('backend.master', ['mainMenu' => 'Divorce', 'subMenu' =>'DivorceCreate'])
@push('style')
@endpush
@section('title', 'Divorce Create')
@section('content')
   ...
   <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Divorce Create</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('divorce.index')}}">Divorce</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Divorce Create Info</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal" id="Form" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="date_of_death" class="col-sm-2 col-form-label">Divorce Name</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="date_of_death" placeholder="Divorce Name" class="form-control" id="date_of_death">
                                    </div>
                                </div>
                                <div class="form-group row">
