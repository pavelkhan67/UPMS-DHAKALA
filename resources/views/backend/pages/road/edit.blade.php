                        ...
                        <form class="form-horizontal" id="roadForm" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="name" value="{{$road->name}}" placeholder="Road" class="form-control" id="name">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="bn_name" value="{{$road->bn_name}}" placeholder="Road Bangla" class="form-control" id="bn_name">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text"  value="{{$road->start_point}}"  id="start_point" class="form-control" name="start_point" placeholder="Enter start point">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="end_point" value="{{$road->end_point}}" class="form-control" name="end_point" placeholder="Enter end point">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" step="any"  placeholder="0.00" name="distance" value="{{$road->distance}}"  class="form-control" id="distance">
                                    </div>
                                </div>
                                        ...
                                        <select required class="form-control select2" name="road_type" id="road_type">
                                             @if (count($road_types))
                                                @foreach ($road_types as $road_type)
                                                    <option value="{{$road_type->id}}" {{ ($road->road_type_id == $road_type->id) ? 'selected' : '' }} >{{$road_type->en_name}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                        ...
                                        <select required class="form-control select2" name="road_category" id="road_category">
                                            ...
                                            @if (count($road_categories))
                                                @foreach ($road_categories as $road_category)
                                                    <option value="{{$road_category->id}}" {{ ($road->road_category_id == $road_category->id) ? 'selected' : '' }} >{{$road_category->en_name}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                        ...
                                        <select required class="form-control select2" name="road_owner" id="road_owner">
                                            ...
                                            @if (count($road_owners))
                                                @foreach ($road_owners as $road_owner)
                                                    <option value="{{$road_owner->id}}" {{ ($road->road_owner_id == $road_owner->id) ? 'selected' : '' }} >{{$road_owner->en_name}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" min="1900"  max="{{date('Y')}}" placeholder="YYYY"  name="make_year" value="{{$road->make_year}}" class="form-control" id="make_year">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="make_contactor" class="col-sm-2 col-form-label">Make Contactor</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="make_contactor" value="{{$road->make_contactor}}" placeholder="Contactor Name" class="form-control" id="make_contactor">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="make_value" class="col-sm-2 col-form-label">Make Value</label>
                                    <div class="col-sm-9">
                                        <input type="number" step="any" placeholder="eg.500000"  name="make_value"  value="{{$road->make_value}}"  class="form-control" id="make_value">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="current_condition" class="col-sm-2 col-form-label">Current Condition</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="current_condition" value="{{$road->current_condition}}" placeholder="Current Condition" class="form-control" id="current_condition">
                                    </div>
                                </div>
