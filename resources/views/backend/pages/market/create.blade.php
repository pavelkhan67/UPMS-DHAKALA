@extends('backend.master', ['mainMenu' => 'Market', 'subMenu' =>'MarketCreate'])
@push('style')
@endpush
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('market.index')}}">Market</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Market Create Info</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal" id="Form" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="date_of_death" class="col-sm-2 col-form-label">Market Name</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="date_of_death" placeholder="Market Name" class="form-control" id="date_of_death">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="date_of_death" class="col-sm-2 col-form-label">Market (Bangla)</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="date_of_death" placeholder="Market Bangla" class="form-control" id="date_of_death">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="date_of_death" class="col-sm-2 col-form-label">Land Qty</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="date_of_death" placeholder="Land Qty" class="form-control" id="date_of_death">
                                    </div>
                                </div>
                                <div class="form-group row">
