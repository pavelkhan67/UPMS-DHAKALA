                        ...
                        <form class="form-horizontal" id="landClassForm" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="land_type_id" class="col-sm-2 col-form-label">Land Category <span class="text-danger" title="Required" data-toggle="Required">*</span></label>
                                    <div class="col-sm-9">
                                        <select required class="form-control select2" name="land_type_id" id="land_type_id">
                                            <option value="">Land Category</option>
                                            @if ($types)
                                                @foreach ($types as $type)
                                                    <option value="{{$type->id}}" @if($type->id == $class->land_type_id) selected @endif >{{$type->en_name}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" required name="en_name" value="{{$class->en_name}}" placeholder="Land Class" class="form-control" id="en_name">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" required name="bn_name" value="{{$class->bn_name}}" placeholder="Land Class Bangla" class="form-control" id="bn_name">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#landClassForm").on('submit', function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('basic-settings.land-class.update', $class->id)}}",
