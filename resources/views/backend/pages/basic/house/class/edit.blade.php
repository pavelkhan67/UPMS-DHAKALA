                        ...
                        <form class="form-horizontal" id="houseClassForm" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="en_name" value="{{$class->en_name}}" placeholder="House Class" class="form-control" id="en_name">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="bn_name" value="{{$class->bn_name}}" placeholder="House Class Bangla" class="form-control" id="bn_name">
                                    </div>
                                </div>
                                        ...
                                        <select required class="form-control select2" name="house_category_id" id="house_category_id">
                                            ...
                                            @if ($categories)
                                                @foreach ($categories as $category)
                                                    <option value="{{$category->id}}" @if($category->id == $class->house_category_id) selected @endif >{{$category->en_name}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#houseClassForm").on('submit', function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('basic-settings.house-class.update', $class->id)}}",
