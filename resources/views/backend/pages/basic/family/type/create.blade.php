                        ...
                        <form class="form-horizontal" id="familyTypeForm" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" required name="en_name" placeholder="Family Type" class="form-control" id="en_name">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" required name="bn_name" placeholder="Family Type Bangla" class="form-control" id="bn_name">
    ...
    <script>
         $(document).ready(function() {
            ...
            $("#familyTypeForm").on('submit', function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('basic-settings.family-type.store')}}",
