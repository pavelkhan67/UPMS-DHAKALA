                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Edit Family Subcategory Info</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal" id="familySubcateogryEditForm" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="card-body">
                                <div class="form-group row">
                                    <label for="family_category_id" class="col-sm-2 col-form-label">Family Category <span class="text-danger" data-toggle="tooltip" title="Required">*</span></label>
                                    <div class="col-sm-9">
                                        <select required class="form-control select2" name="family_category_id" id="family_category_id">
                                            ...
                                            @if ($categories)
                                                @foreach ($categories as $category)
                                                    <option value="{{$category->id}}" @if ($category->id == $subcategory->family_category_id) selected @endif >{{$category->en_name}}</option> 
                                                @endforeach
                                            @endif
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="en_name" value="{{$subcategory->en_name}}"  placeholder="Family Sub-Category" class="form-control" id="en_name">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="bn_name" value="{{$subcategory->bn_name}}" placeholder="Family Sub-Category Bangla" class="form-control" id="bn_name">
...
<script>
    $(document).ready(function() {
       ...
       $("#familySubcateogryEditForm").on('submit', function(e) {
           ...
           $.ajax({
               type: "POST",
               url: "{{route('basic-settings.family-subcategory.update', $subcategory->id)}}",
