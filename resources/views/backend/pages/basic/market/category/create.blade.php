                        ...
                        <form class="form-horizontal" id="marketCategoryInfo" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="en_name" placeholder="Market Category" class="form-control" id="en_name">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="bn_name" class="col-sm-2 col-form-label">Market Category Bangla</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="bn_name" placeholder="Market Category Bangla" class="form-control" id="bn_name">
                                    </div>
                                </div>
...
@push('script')
    ...
    <script>
         $(document).ready(function() {
             $(".select2").select2();
            $("#marketCategoryInfo").on('submit', function(e) {
                e.preventDefault();
                let thisForm = $(this);
                $.ajax({
                    type: "POST",
                    url: "{{route('basic-settings.market-category.store')}}",
