      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('basic-settings.market-ownership-type.index')}}">Market Type</a></li>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#marketCateogryForm").on('submit', function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('basic-settings.market-ownership-type.update', $type->id)}}",
