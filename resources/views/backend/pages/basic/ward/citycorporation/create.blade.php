                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">City Corporation Ward Info</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal" id="cityCorporationWardForm" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" min="1" max="150"  name="en_ward_no" placeholder="Ward No" class="form-control" id="en_ward_no">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="bn_ward_no" placeholder="Ward No Bangla" class="form-control" id="bn_ward_no">
    ...
    <script>
         $(document).ready(function() {
            ...
            $("#cityCorporationWardForm").on('submit', function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('basic-settings.city-corporation-ward.store')}}",
