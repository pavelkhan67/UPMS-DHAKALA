                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Profession Subcategory Info</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal" id="professionSubcategoryForm" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <small class="error text-danger profession_id_error"></small>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <small class="error text-danger profession_type_id_error"></small>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select required class="form-control select2" name="profession_category_id" id="profession_category_id">
                                            <option value="">Profession Category</option>
                                        </select>
                                        <small class="error text-danger profession_category_id_error"></small>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" required name="en_name" placeholder="Profession Subcategory" class="form-control" id="en_name">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" required name="bn_name" placeholder="Profession Subcategory Bangla" class="form-control" id="bn_name">
                            ...
                            <div class="card-footer">
                                <div class="form-group row">
                                    <a href="{{route('basic-settings.profession-subcategory.index')}}" class="btn btn-default float-right">Cancel</a>
                                    <div class="col-sm-9">
...
@push('script')
    ...
    <script>
         $(document).ready(function() {
             $(".select2").select2();
            $("#professionSubcategoryForm").on('submit', function(e) {
                e.preventDefault();
                let thisForm = $(this);
                $.ajax({
                    type: "POST",
                    url: "{{route('basic-settings.profession-subcategory.store')}}",
        ...
        $(document).on('change', '#profession_type_id', function(e){
            ...
            if(profession_type_id){
                $.ajax({
                    type: "GET",
                    url: "{{url('/profession-category-options-by-profession-type')}}/"+profession_type_id,
                    beforeSend: function() {
                       console.log("Searcing...");
