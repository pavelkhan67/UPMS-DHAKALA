      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('basic-settings.profession.index')}}">Profession</a></li>
                        ...
                        <form class="form-horizontal" id="professionForm" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="en_name" value="{{$profession->en_name}}" placeholder="Profession" class="form-control" id="en_name">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="bn_name" value="{{$profession->bn_name}}" placeholder="Profession Bangla" class="form-control" id="bn_name">
                            ...
                            <div class="card-footer">
                                <div class="form-group row">
                                    <a href="{{route('basic-settings.profession.index')}}" class="btn btn-default float-right">Cancel</a>
                                    <div class="col-sm-9">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#professionForm").on('submit', function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('basic-settings.profession.update', $profession->id)}}",
                    ...
                    success: function (response) {
                        ...
                        setTimeout(function() {
                            location.href = "{{route('basic-settings.profession.index')}}";
                        }, 2000)
                    },
