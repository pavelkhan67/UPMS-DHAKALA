            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal" id="professionTypeForm" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="en_name" placeholder="Profession Type" class="form-control" id="en_name">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="bn_name" placeholder="Profession Type Bangla" class="form-control" id="bn_name">
...
@push('script')
    ...
    <script>
         $(document).ready(function() {
             $(".select2").select2();
            $("#professionTypeForm").on('submit', function(e) {
                e.preventDefault();
                let thisForm = $(this);
                $.ajax({
                    type: "POST",
                    url: "{{route('basic-settings.profession-type.store')}}",
