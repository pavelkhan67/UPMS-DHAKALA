                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Profession Category Info</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal" id="professionCategoryForm" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                        ...
                                        <select required class="form-control select2" name="profession_type_id" id="profession_type_id">
                                            ...
                                            @if ($types)
                                                @foreach ($types as $item)
                                                    <option value="{{$item->id}}"> {{$item->profession->en_name}} - {{$item->en_name}}</option>
                                                @endforeach
                                            @endif
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" required name="en_name" placeholder="Profession Category" class="form-control" id="en_name">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" required name="bn_name" placeholder="Profession Category Bangla" class="form-control" id="bn_name">
...
@push('script')
    ...
    <script>
         $(document).ready(function() {
             $(".select2").select2();
            $("#professionCategoryForm").on('submit', function(e) {
                e.preventDefault();
                let thisForm = $(this);
                $.ajax({
                    type: "POST",
                    url: "{{route('basic-settings.profession-category.store')}}",
