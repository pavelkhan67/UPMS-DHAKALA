                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">Organization Work Area Info</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal" id="organizationWorkAreaForm" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" required name="en_name" placeholder="Organization Work Area" class="form-control" id="en_name">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" required name="bn_name" placeholder="Organization Work Area Bangla" class="form-control" id="bn_name">
    ...
    <script>
         $(document).ready(function() {
            ...
            $("#organizationWorkAreaForm").on('submit', function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('basic-settings.organization-work-area.store')}}",
