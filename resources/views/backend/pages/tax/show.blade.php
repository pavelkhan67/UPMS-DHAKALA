                                ...
                                <div class="tabl-responsive">
                                    ...
                                    <table class=" table my-2 user_info_table">
                                        <tr>
                                            ...
                                            <td> নাম: <strong class="user_name">{{$tax->user->people->bn_name ?? ''}}</strong> </td>
                                            <td> পিতার নাম: <strong class="user_father_name">{{$tax->user->familyInfo->father_name_bn ?? ''}}</strong></td>
                                        </tr>
                                    </table>
                                    ...
                                    <table class="table table-bordered text-center">
                                        ...
                                        <tbody >
                                            ...
                                            <tr>
                                                ...
                                                <td  class="text-right">{{$tax->previous_land_tax ?? ''}}</td>
                                                <td  class="text-right">{{$tax->land_tax ?? ''}}</td>
                                            </tr>

                                            <tr>
                                                <td>৭ ।</td>
                                                <td  class="text-left">নিলামে বিক্রয়লব্ধ আয়</td>
                                                <td  class="text-right">{{$tax->previous_auction_tax ?? ''}}</td>
                                                <td  class="text-right">{{$tax->auction_tax ?? ''}}</td>
                                            </tr>

                                            <tr>
                                                <td>৮ ।</td>
                                                <td  class="text-left">জরিমানা (যদি থাকে)</td>
                                                <td  class="text-right">{{$tax->previous_fine ?? ''}}</td>
                                                <td  class="text-right">{{$tax->fine ?? ''}}</td>
                                            </tr>

                                            <tr>
                                                <td>৯ ।</td>
                                                <td  class="text-left">অন্যান্য দাবি আদায় (যদি থাকে)</td>
                                                <td  class="text-right">{{$tax->previous_others ?? ''}}</td>
                                                <td  class="text-right">{{$tax->others ?? ''}}</td>
                                            </tr>

                                            <tr>
                                                <td>১০ ।</td>
                                                <td  class="text-left">বিবিধ</td>
                                                <td  class="text-right">{{$tax->previous_extra ?? ''}}</td>
                                                <td  class="text-right">{{$tax->extra ?? ''}}</td>
                                            </tr>
                                        </tbody>
                                        <tfoot>
                                            <tr >
